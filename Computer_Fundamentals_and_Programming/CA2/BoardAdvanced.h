...
#define width 49
#define height 7
void Board(int P1[4][11], int Score[2], int cards[4][2], int first_player, char main_symbol, int round[2], int winner)
{
    int num = 0;
    char enter[100];
    system("cls");
    printf("\nRound: %d\tTeam1 rounds won: %d\tTeam2 rounds won: %d", round[0]+round[1]+1, round[0], round[1]);
    if (main_symbol != -1)
    {
