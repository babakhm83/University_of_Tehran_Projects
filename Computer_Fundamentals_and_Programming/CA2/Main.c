...
int main()
{
    ...
    Board(cards_player1, score, cards_played_player, first_player, main_symbol, text);
    do
    {
        fflush(stdin);
    ...
    do
    {
        ...
        for (m, j; m < 4 && j < 4; m++, j++) /*Player and bots choose their cards*/
        {
            ...
            case P2:
            {
                last_card_played = Bot(cards_player2, first_card_symbol, main_symbol_num);
            ...
            case P3:
            {
                last_card_played = Bot(cards_player3, first_card_symbol, main_symbol_num);
            ...
            case P4:
            {
                last_card_played = Bot(cards_player4, first_card_symbol, main_symbol_num);
    ...
    if (score[0] == 6)
    {
        printf("The winner is Team1!");
    }
    else
    {
        printf("The winner is Team2!");
    }
}