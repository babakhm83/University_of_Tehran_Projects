...
# Pleas add other module here	
	...
	vlog 	+acc -incr -source  +define+SIM 	$hdl_path/Controller_fifo.v
	vlog 	+acc -incr -source  +define+SIM 	$hdl_path/Controller_PE_generator.v
